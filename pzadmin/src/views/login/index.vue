...
// import.meta.url是es模块的语法，只能在模块中使用
...
const validatePass = (rule, value, callback) => {
  ...
  if (value === '') {
    ...
    // const passReg = /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{4,16}$/ // 密码必须包含数字和字母，长度4-16位
...
const rules = reactive({
  userName: [{ validator: validateUser, trigger: 'blur' }], // blur 失去焦点
    ...
    <el-card style="max-width: 480px">
      ...
      <el-form ref="loginFormRef" :model="loginForm" style="max-width: 600px;" class="demo-ruleForm" :rules="rules">
        ...
        <el-form-item prop="passWord">
          <el-input v-model="loginForm.passWord" placeholder="密码" :prefix-icon="Lock" type="password"></el-input>
        </el-form-item>
